...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.project_main2);
...
// 로그인 시 입력한 id 값 뿌려주기
    ...
    // 마이페이지 확장 리스트뷰 부분    
        ...
        findViewById(R.id.btn_register2).setOnClickListener(mClick);
...
//            frame5.setVisibility(View.INVISIBLE);
            ...
            switch(v.getId())
            {
                ...
                case R.id.btnGo:
                    Intent activity_search = new Intent(MainActivity2.this, Search1.class);
                    startActivity(activity_search);
                    break;

                case R.id.local_1:
                    Intent local1 = new Intent(MainActivity2.this, ProjectLocal1.class);
                    startActivity(local1);
                    break;

                case R.id.local_2:
                    Intent local2 = new Intent(MainActivity2.this, ProjectLocal2.class);
                    startActivity(local2);
                    break;

                case R.id.local_3:
                    Intent local3 = new Intent(MainActivity2.this, ProjectLocal3.class);
                    startActivity(local3);
                    break;

                case R.id.local_4:
                    Intent local4 = new Intent(MainActivity2.this, ProjectLocal4.class);
                    startActivity(local4);
                    break;

                case R.id.local_5:
                    Intent local5 = new Intent(MainActivity2.this, ProjectLocal5.class);
                    startActivity(local5);
                    break;

                case R.id.local_6:
                    Intent local6 = new Intent(MainActivity2.this, ProjectLocal6.class);
                    startActivity(local6);
                    break;

                case R.id.btnSpring:
                    Intent spring = new Intent(MainActivity2.this, ProjectSpring.class);
                    startActivity(spring);
                    break;

                case R.id.btnSummer:
                    Intent summer = new Intent(MainActivity2.this, ProjectSummer.class);
                    startActivity(summer);
                    break;

                case R.id.btnFall:
                    Intent fall = new Intent(MainActivity2.this, ProjectFall.class);
                    startActivity(fall);
                    break;

                case R.id.btnWinter:
                    Intent winter = new Intent(MainActivity2.this, ProjectWinter.class);
                    startActivity(winter);
                    break;
                case R.id.btn_register2:
                    Intent btnrg2 = new Intent(MainActivity2.this, RegisterActivity.class);
                    startActivity(btnrg2);
                    break;
            }
